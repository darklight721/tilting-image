    ...
    _createClass(TiltImage, [{
      ...
      value: function render() {
        ...
        return _React['default'].createElement(
          'div',
          _extends({}, attrs, { style: containerStyle, onMouseOver: this.tilt.bind(this) }),
      ...
      value: function tilt(evt) {
        ...
        var rotateX = map(evt.clientX, 0, targetEl.clientWidth, -MAX_ROTATE, MAX_ROTATE);
        var rotateY = map(evt.clientY, 0, targetEl.clientHeight, -MAX_ROTATE, MAX_ROTATE);
